        ...
        <div id="about">
            <div id="About_container">
                ...
                <p style={{paddingBottom:"20px"}}>
                    ...
                    and rarible NFTs, and therefore make cryptocurrency off the material they sold to people 
                    who want to learn a subject off them. Then to make sure that children are getting well educated
                    and not scammed, parents will buy these "NFTs" for a limited time to forever for prices 
                    educators or students set them to. 
                </p>
            </div>
        </div>
    );
